      ...
      <div style={styles.overlay}>
        <div style={styles.popup}>
          ...
          <p style={styles.message}>
            L'application Android est en cours de développement, elle sera prête très bientôt ! Cependant, vous pouvez contacter nous par courriel à <a href="mailto:classmoschool@gmail.com">l'adresse e-mail suivante</a> pour faire partie de la bêta et être parmi les premiers à tester l'application dès sa sortie.
          </p>
